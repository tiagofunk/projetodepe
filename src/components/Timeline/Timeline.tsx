...
export const Timeline = () => {
  const TIMELINE_TEXT = [
    ...
    [
      "19/10/2021",
      "Primeira reunião com Luiza Serpa do instituto Phi, o Phi entra no projeto.",
    ],
    ...
    [
      "19/01/2022",
      "Gabriela Santos entrou no projeto ( advogada especialista em direito autoral/ propriedade intelectual).",
    ],
